    ...
    <div className='flex justify-center items-center w-full h-auto'>
      <div className='flex md:flex-row-reverse flex-col justify-center items-center lg:max-w-screen-lg md:w-10/12 w-11/12 h-auto m-8'>
        ...
        <div className='flex flex-col justify-center md:items-start items-center'>
          ...
          <p className='md:my-0 my-4 text-xs md:text-left text-center'>
            誰もが平等に評価される世界を目指し、そして実現をするためにTeam GINTAMA は 
            <span className='font-bold'>EVE<span className='text-base text-blue-400'>N</span></span>
            を作りました。<br className='md:inline hidden'/>
            <span className='font-bold'>EVE<span className='text-base text-blue-400'>N</span></span>
            がある世界では無駄な努力ななんてありません。全ての努力に意味があるのです。<br/>
          </p>
